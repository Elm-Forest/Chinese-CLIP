...
ROOTPATH=K:/project/chinese-CLIP
DATAPATH=taidi_data

# data options
train_data=${ROOTPATH}/${DATAPATH}/lmdb/train
val_data=${ROOTPATH}/${DATAPATH}/lmdb/valid # if val_data is not specified, the validation will be automatically disabled

# restore options
resume=${ROOTPATH}/weights/clip_cn_vit-l-14-336.pt # or specify your customed ckpt path to resume
reset_data_offset="--reset-data-offset"
reset_optimizer="--reset-optimizer"
# reset_optimizer=""

# output options
output_base_dir=${ROOTPATH}/experiments/
name=finetune_vit-l-14_roberta-base_bs2
