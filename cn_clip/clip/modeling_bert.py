...
class BertEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.layer_post = nn.ModuleList([BertLayer(config) for _ in range(8)])
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None):
        ...
        for i, layer_module in enumerate(self.layer_post):
            if self.output_hidden_states:
                all_hidden_states = all_hidden_states + (hidden_states,)
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None):
        ...
        if head_mask is not None:
            if head_mask.dim() == 1:
                ...
                head_mask = head_mask.expand(self.config.num_hidden_layers + 8, -1, -1, -1, -1)
            ...
            head_mask = [None] * (self.config.num_hidden_layers + 8)
